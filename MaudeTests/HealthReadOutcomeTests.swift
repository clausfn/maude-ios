...
struct HealthReadOutcomeTests {
    ...
    @Test func noReadingsCopyDoesNotAccuse() {
        ...
        let lead = String(localized: "That can mean two things, and we can't tell them apart from here: either Maude wasn't given permission to read, or there's simply nothing recorded on this phone yet. Until readings arrive you'll see sample data, clearly marked so you never mistake it for your own.")
