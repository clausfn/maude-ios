...
//   the tap can open that card's evidence view (Liviqa's answer to score
...
//     Liviqa cannot time and cannot interpret. The nudge still sits at the top
...
enum EarnedAttention {
    ...
    static let requestID = "liviqa.attention.earned"
    ...
    static let bandTemplate = Template(
        ...
        body: String(localized: "One of your own numbers is away from your usual today. Liviqa has shown its working in today's edition."))

    static let leverTemplate = Template(
        category: .behaviouralLever,
        title: String(localized: "One thing worth a minute"),
        body: String(localized: "Something in your own pattern moved away from your usual today. Liviqa has shown its working in today's edition."))
