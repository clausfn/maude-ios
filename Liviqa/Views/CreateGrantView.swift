        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Button { onDismiss() } label: {
                    Text("Cancel").font(.lato(15)).foregroundStyle(LiviqaTheme.ink3)
                }
                Spacer()
                Text("New grant")
                    .font(.liviqaSerif(16))
    ...
    private func typeRow(_ c: GrantRecipientChoice) -> some View {
        ...
        return Button {
            ...
            HStack(alignment: .top, spacing: 11) {
                ZStack {
                    Circle()
                        .stroke(on ? LiviqaTheme.moss : LiviqaTheme.ink4, lineWidth: 1.5)
                        .background(Circle().fill(on ? LiviqaTheme.moss : Color.clear))
            ...
            .background(on ? LiviqaTheme.moss2.opacity(0.5) : LiviqaTheme.paper2)
