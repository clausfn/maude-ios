...
//  • the iris mark ("LiviqaMark") small in the header;
...
enum HealthSummaryPDF {
    ...
    static func render(_ doc: HealthSummaryDocument) -> Data {
        ...
        format.documentInfo = [
            kCGPDFContextTitle as String: "Liviqa \(HealthSummaryDocument.title)",
            kCGPDFContextCreator as String: "Liviqa",
        ]
    ...
    static func writeTemporaryFile(_ doc: HealthSummaryDocument) -> URL? {
        ...
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("Liviqa health summary.pdf")
