...
enum DonationCopy {
    ...
    static let donorClaim = String(localized:
        "Nothing in Liviqa sends your individual readings anywhere. The one exception is the donation you signed for: you export an encrypted copy yourself and hand it to Data for Good's engineers. That happens only when you do it, and you can withdraw at any time.")
