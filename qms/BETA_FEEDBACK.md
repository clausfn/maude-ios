...
|---|---|---|---|---|---|
| FB-AIJMHfz6 | 06-13 | 10.43 | "We need to add two consent boxes to this page: ☑ Allow me to be included in anonymous cohort discovery; ☑ Allow me and my data to be discovered for anonymous research — with some explanation as to what they allow" (Brian Connelly) | Screenshot is the **DfG onboarding intro** (`DfGOnboardingView`), not the in-app Privacy screen. Needs two opt-in (default OFF) consent toggles + one-line explanations, written to the consent ledger, revocable in Privacy. Same ask as FB-AGtO8N6h #2, re-raised by Brian against the onboarding screen. | **OPEN** — ClickUp 86exykhzh; awaiting Claus's approval before build |
