...
// MaudeApp) that posts the hex token; AppState forwards it to the backend
...
// they arrive via `xcrun simctl push booted xyz.ppcn.maude <payload>` with
...
extension Notification.Name {
    ...
    static let maudeOpenAttention = Notification.Name("MaudeOpenAttention")
}
...
final class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication,
        ...
        NotificationCenter.default.post(name: .maudePushToken, object: hex)
    }
...
extension AppDelegate: UNUserNotificationCenterDelegate {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        if isResearchPayload(notification.request.content.userInfo) {
            NotificationCenter.default.post(name: .maudeResearchReceived, object: nil)
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        if isResearchPayload(info) {
            NotificationCenter.default.post(name: .maudeOpenResearch, object: nil)
            ...
            NotificationCenter.default.post(name: .maudeOpenAttention,
                                            object: info["nudge"] as? String)
        } else if isEditionPayload(info) {
            NotificationCenter.default.post(name: .maudeOpenEdition, object: nil)
        }
        completionHandler()
    }
}
