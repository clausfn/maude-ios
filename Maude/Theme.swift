...
// Source: design_handoff_maude_a7 (A7.2) — "Migrate to A7.2 - Coding Prompt.md" + tokens.css.
...
// red-is-clinical-glucose-only lock (RK-ALARM-01); see qms/RISK.md PR-105. Every `MaudeTheme.*`
...
extension Font {
    ...
    static var maudeH1: Font { scaledSerif(30, .bold, .largeTitle) }
    static var maudeH2: Font { scaledSerif(20, .bold, .title3) }
