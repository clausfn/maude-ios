...
public final class KeyVault {
    ...
    private let deviceKeyAccount = "maude.device-key.v1"
    private let wrappedDEKAccount = "maude.wrapped-dek.v1"
    ...
    public init(service: String? = nil,
        ...
        let service = service ?? (Bundle.main.bundleIdentifier ?? "xyz.ppcn.maude") + ".keyvault"
...
public struct DeviceKeyFileStore {
    ...
    public init(service: String, directory: URL? = nil) {
        ...
        self.directory = base.appendingPathComponent("maude-keystore", isDirectory: true)
    }
