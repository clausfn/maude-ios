...
// Health shows and what Maude said becomes inspectable from one text file.
//
...
public enum SleepDiagnostics {
    ...
    public static func report(_ input: Input) -> String {
        ...
        out.append("MAUDE SLEEP DIAGNOSTICS")
        ...
        out.append("sources, stages, start/end times and Maude's derived sleep figures.")
        ...
        out.append("\"Derived\" line with what Maude's sleep screens showed. If the two")
