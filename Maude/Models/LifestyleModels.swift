...
enum CorrelationLevel: Int, CaseIterable {
    ...
    var color: Color {
        switch self {
        case .noData:  return MaudeTheme.line2
        case .low:     return MaudeTheme.moss3
        case .medium:  return MaudeTheme.moss.opacity(0.45)
        case .high:    return MaudeTheme.moss
        case .outlier: return MaudeTheme.amber
        }
    }
...
enum TokenTransactionType {
    ...
    var color: Color {
        switch self {
        case .earned:  return MaudeTheme.moss
        case .spent:   return MaudeTheme.ink3
        case .donated: return MaudeTheme.moss   // giving is positive
        }
    }
