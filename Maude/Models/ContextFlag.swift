...
//
// Bevel absorb ③, expressed in Maude's voice. The user marks a stretch of days
// as travelling / unwell / off-routine. The marker is DECLARED DATA — the user
// says it, Maude never infers it — and its ONLY effect on the intelligence
...
public nonisolated enum ContextFlagKind: String, Codable, Sendable, CaseIterable, Identifiable {
    ...
    var todayDetail: String {
        switch self {
        case .travelling:
            return String(localized: "You've marked these days as travelling. Your readings are still recorded and still yours — Maude just won't read them as drifting from your usual.")
        case .unwell:
            return String(localized: "You've marked these days as unwell. Your readings are still recorded and still yours — Maude just won't read them as drifting from your usual.")
        case .offRoutine:
            return String(localized: "You've marked these days as off routine. Your readings are still recorded and still yours — Maude just won't read them as drifting from your usual.")
        }
    }
...
/// construction never crosses into `Maude/Intelligence` — the engine is handed
