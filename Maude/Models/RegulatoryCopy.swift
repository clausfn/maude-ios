...
enum RegulatoryCopy {
    ...
    static let mdrNotice = String(localized:
        "Maude is a personal wellness application, not a medical device. It does not diagnose, treat, monitor, or manage any medical condition. Patterns are generated from your own data for your own awareness. Always consult a qualified healthcare professional before changing your care, medication, or treatment.")
    ...
    static let dfgWellnessFooter = String(localized:
        "Maude is made by the non-profit Data for Good Foundation. It describes patterns in your own data — it does not diagnose or treat.")
}
