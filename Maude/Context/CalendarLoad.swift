...
//
//     Maude reads how FULL a day was. It never reads, keeps, logs, sends or
...
// `Maude/Ingestion/CalendarLoadIngestor.swift` and does nothing but produce
// `[ScheduledInterval]`.
import Foundation
...
///
/// It is an ARITHMETIC WINDOW, not advice. Maude does not recommend an hour to
