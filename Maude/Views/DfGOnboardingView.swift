...
//      URL (maude.app), DfG logo added to Page 1 icon + LearnMoreSheet.
            ...
            VStack(spacing: 0) {
                ...
                HStack(spacing: 8) {
                    ForEach(0..<3, id: \.self) { index in
                        Circle()
                            .fill(index == currentPage ? MaudeTheme.moss : MaudeTheme.line2)
        ...
        VStack(spacing: 0) {
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    // (MaudeTheme.paper), so the locked logo rule requires the
        ...
        VStack(spacing: 0) {
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    // Body — paragraph 1
                    Text("Each time you grant or withdraw access, that decision is written to an independent record. It cannot be edited, deleted, or backdated — by anyone, including Maude.")
                        .font(.lato(15))
                        .foregroundStyle(MaudeTheme.ink2)
                        .lineSpacing(3)
                        .fixedSize(horizontal: false, vertical: true)
                    ...
                    // Caption
                    Text("No one, including Maude, can alter this record.")
                        .font(.lato(11.5))
                        .italic()
                        .foregroundStyle(MaudeTheme.ink4)
                        .frame(maxWidth: .infinity)
        ...
        VStack(spacing: 0) {
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    // Body
                    Text("All processing happens on this device. You decide whether and where to back up your Maude data. The default is on-device only — nothing leaves unless you choose it.")
                        .font(.lato(15))
                        .foregroundStyle(MaudeTheme.ink2)
                        .lineSpacing(3)
                        .fixedSize(horizontal: false, vertical: true)
                    ...
                    // GDPR footnote
                    Text("Your rights under GDPR Articles 15–22 apply in full. Full legal text at maude.app/privacy")
                        .font(.lato(11))
                        .foregroundStyle(MaudeTheme.ink4)
                        .multilineTextAlignment(.center)
                        .frame(maxWidth: .infinity)
...
struct ExpandableNote: View {
    ...
    var body: some View {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 12)
                .stroke(MaudeTheme.moss3, lineWidth: 0.5)
        )
    }
}
...
struct ConsentCheckRow: View {
    ...
    var body: some View {
        Button { isOn.toggle() } label: {
            HStack(alignment: .top, spacing: 12) {
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: 6)
                        .fill(isOn ? MaudeTheme.moss : Color.clear)
                    RoundedRectangle(cornerRadius: 6)
                        .stroke(isOn ? MaudeTheme.moss : MaudeTheme.line, lineWidth: 1.5)
                    if isOn {
            ...
            .padding(14)
            .background(isOn ? MaudeTheme.moss2 : MaudeTheme.paper2)
            .clipShape(RoundedRectangle(cornerRadius: 12))
            .overlay(
                RoundedRectangle(cornerRadius: 12)
                    .stroke(isOn ? MaudeTheme.moss3 : MaudeTheme.line, lineWidth: isOn ? 1 : 0.5)
            )
        ...
        Button(action: onTap) {
            HStack(alignment: .top, spacing: 14) {
                ...
                Image(systemName: option.icon)
                    .font(.lato(18))
                    .foregroundStyle(isSelected ? MaudeTheme.moss : MaudeTheme.ink3)
                    .frame(width: 24)
                    .padding(.top, 2)
                ...
                ZStack {
                    Circle()
                        .stroke(isSelected ? MaudeTheme.moss : MaudeTheme.line, lineWidth: 1.5)
            ...
            .padding(14)
            .background(isSelected ? MaudeTheme.moss2 : MaudeTheme.paper2)
            .clipShape(RoundedRectangle(cornerRadius: 12))
            .overlay(
                RoundedRectangle(cornerRadius: 12)
                    .stroke(
                        isSelected ? MaudeTheme.moss : MaudeTheme.line,
