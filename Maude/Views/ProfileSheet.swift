...
struct ProfileSheet: View {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("Maude uses this to personalise your nudges. Stays on device.")
                                .font(.footnote)
    ...
    private func conditionChip(_ entry: ConditionEntry) -> some View {
        ...
        .background(MaudeTheme.moss2.opacity(0.5))
    ...
    private var targetsContent: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("These values come from your care plan. Maude uses them to calibrate what's inside vs outside your personal range.")
                .font(.caption)
                .foregroundStyle(MaudeTheme.ink4)
                .padding(.top, 4)
        }
