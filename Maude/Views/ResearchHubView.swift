...
struct ResearchHubView: View {
    ...
    var body: some View {
        ...
        .task {
            ...
            if ProcessInfo.processInfo.environment["MAUDE_OPEN_HUBSTUDY"] == "1",
    ...
    private func openStudyCard(_ study: ResearchStudy) -> some View {
        Button { reviewingStudy = study } label: {
            ...
            .background(MaudeTheme.paper2)
            .clipShape(RoundedRectangle(cornerRadius: 16))
            .overlay(RoundedRectangle(cornerRadius: 16).stroke(MaudeTheme.accentRecovery.opacity(0.4), lineWidth: 1))
            .shadow(color: MaudeTheme.cardShadow, radius: 8, y: 3)
        }
        .buttonStyle(.plain)
    }
    ...
    private var noStudiesCard: some View {
        ...
        .background(MaudeTheme.paper2)
        .clipShape(RoundedRectangle(cornerRadius: 16))
        .overlay(RoundedRectangle(cornerRadius: 16).stroke(MaudeTheme.line2, lineWidth: 1))
    }
