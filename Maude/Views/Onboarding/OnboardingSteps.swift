...
struct OnbStepHead: View {
    ...
    let title: String
    let lead: String
    var accent: Color = MaudeTheme.moss
    var compact = false
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Text(title)
                .font(.maudeSerif(compact ? 24 : 27, .bold, relativeTo: .title2))
                .kerning(MaudeTheme.Tracking.h1)
...
struct OnbIconChip: View {
    ...
    var color: Color = MaudeTheme.moss
    var side: CGFloat = 30
...
struct OnbBenefitRow: View {
    ...
    let title: String
    let sub: String
    var chipColor: Color = MaudeTheme.moss
    var divider = false

    var body: some View {
        VStack(spacing: 0) {
            if divider { Divider().overlay(MaudeTheme.line) }
...
struct OnbPrimaryButton: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .shadow(color: MaudeTheme.primaryGlow, radius: 10, y: 6)
        }
        .buttonStyle(.plain)
    }
}
...
struct OnbQuietButton: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .background(MaudeTheme.ink.opacity(0.10))
            .clipShape(RoundedRectangle(cornerRadius: 14))
        }
        .buttonStyle(.plain)
    }
...
// MARK: - Step 1 · Why Maude (2 sub-pages)
//
// Page 2 is the EXPECTATION page (FR-SMP-06, CN directive 2026-08-13: "make it
// clear in the opening instructions that Maude is targeted for people
        ...
        VStack(spacing: 0) {
            ...
            HStack(spacing: 5) {
                ForEach(0..<2, id: \.self) { d in
                    Circle()
                        .fill(d == sub ? MaudeTheme.moss : MaudeTheme.ink.opacity(0.22))
    ...
    private var pageOne: some View {
        VStack(alignment: .leading, spacing: 12) {
            OnbStepHead(
                ...
                title: String(localized: "Apple Health keeps your numbers. Maude tells you what they mean."),
                lead: String(localized: "Your phone already collects the readings. Maude reads them here on the device and gives you one plain answer a day — measured against your own normal, not a population average."),
            ...
            OnbCard {
                ...
                OnbBenefitRow(icon: "waveform.path.ecg",
                              ...
                              sub: String(localized: "Apple Health shows the value. Maude learns what is usual for you, and tells you when it moves."),
                              divider: true)
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            OnbCard {
                ...
                OnbBenefitRow(icon: "scalemass",
                              ...
                              chipColor: MaudeTheme.accentBody,
                              divider: true)
            }
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                expectationRow(day: String(localized: "Day 1"),
                               text: String(localized: "Almost nothing happens. Maude reads what is already on your phone and starts learning your normal. Empty is the honest answer, so empty is what you get."))
            ...
            Text("Maude will never fill a quiet week with numbers nobody measured. If you want to see what it looks like with data in it before yours arrives, you can turn on clearly-marked sample data at the Apple Health step.")
                .font(.lato(12))
                .lineSpacing(4)
                .foregroundStyle(MaudeTheme.ink2)
                .fixedSize(horizontal: false, vertical: true)
    ...
    private func expectationRow(day: String, text: String, last: Bool = false) -> some View {
        HStack(alignment: .top, spacing: 11) {
            VStack(spacing: 0) {
                ...
                if !last {
                    Rectangle()
                        .fill(MaudeTheme.moss.opacity(0.3))
                        .frame(width: 1.5)
...
struct DfGGovernanceStep: View {
    ...
    private var pageOne: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Text("An independent body that works for you — not for institutions.")
                .font(.maudeSerif(21, .bold, relativeTo: .title3))
                .kerning(MaudeTheme.Tracking.h1)
                .foregroundStyle(MaudeTheme.ink)
                .multilineTextAlignment(.center)
                .fixedSize(horizontal: false, vertical: true)
            ...
            Text("Every time anyone requests your health data, a neutral record is created. Not by Maude. Not by the requester. By a foundation that answers to you — and represents your interests in the data economy.")
                .font(.lato(13.5))
                .lineSpacing(4)
                .foregroundStyle(MaudeTheme.ink2)
                .fixedSize(horizontal: false, vertical: true)
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Divider().overlay(MaudeTheme.moss3).padding(.top, 8)
    ...
    private var pageTwo: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Text("Each time you grant or withdraw access, that decision is written to an independent record. It is designed so that record cannot be edited, deleted, or backdated — by anyone, including Maude.")
                .font(.lato(13.5))
                .lineSpacing(4)
                .foregroundStyle(MaudeTheme.ink2)
                .fixedSize(horizontal: false, vertical: true)
            ...
            Text("It is designed so no one, including Maude, can alter this record.")
                .font(.lato(11.5))
                .italic()
                .foregroundStyle(MaudeTheme.ink4)
                .frame(maxWidth: .infinity)
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    OnbStepHead(
                        ...
                        title: String(localized: "What should Maude call you?"),
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        Text(previewName.map { "Good morning, \($0)." } ?? "Good morning.")
                            .font(.maudeSerif(22, .bold, relativeTo: .title3))
                            .foregroundStyle(MaudeTheme.ink)
                            .padding(.top, 6)
                    ...
                    .background(MaudeTheme.moss2)
                    .clipShape(RoundedRectangle(cornerRadius: 16))
                    .overlay(RoundedRectangle(cornerRadius: 16).stroke(MaudeTheme.moss3, lineWidth: 1))
                    .padding(.top, 18)
                }
                .padding(.horizontal, 26)
            }
                        ...
                        Button { openSection = tile.id } label: {
                            HStack(spacing: 12) {
                                OnbIconChip(systemName: tile.icon,
                                            color: filled ? MaudeTheme.moss
                                                          : MaudeTheme.ink.opacity(0.10))
                                VStack(alignment: .leading, spacing: 2) {
                                    Text(tile.title)
                                ...
                                ZStack {
                                    Circle()
                                        .stroke(filled ? MaudeTheme.moss : MaudeTheme.ink.opacity(0.2),
                                                lineWidth: 1.5)
                                    if filled {
                                        Circle().fill(MaudeTheme.moss)
                                        Image(systemName: "checkmark")
                                        ...
                                        Image(systemName: "plus")
                                            .font(.system(size: 11, weight: .semibold))
                                            .foregroundStyle(MaudeTheme.ink.opacity(0.4))
                                    }
                                }
                            ...
                            .padding(.horizontal, 14)
                            .padding(.vertical, 12)
                            .background(filled ? MaudeTheme.moss2 : MaudeTheme.paper2)
                            .clipShape(RoundedRectangle(cornerRadius: 14))
                            .overlay(RoundedRectangle(cornerRadius: 14)
                                .stroke(filled ? MaudeTheme.moss3 : MaudeTheme.line, lineWidth: 1))
                        }
                        .buttonStyle(.plain)
                        .padding(.bottom, 8)
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    OnbStepHead(
                        ...
                        lead: String(localized: "Maude is free to use just for yourself. If you ever want to share, it's always a summary — never your raw readings."),
                        accent: accent, compact: true)

                    kickerLabel(String(localized: "Available now"))
                        .padding(.bottom, 8)
                    connRow(icon: "doc.text", color: MaudeTheme.moss,
                            ...
                            now: true)
                    connRow(icon: "person", color: MaudeTheme.moss,
                    ...
                    kickerLabel(String(localized: "Coming later — always off until you choose"))
                        .padding(.top, 14)
                        .padding(.bottom, 8)
                    connRow(icon: "globe.europe.africa", color: MaudeTheme.accentRecovery,
                            ...
                            now: false)
                    connRow(icon: "sparkles", color: MaudeTheme.accentRecovery,
                    ...
                    .clipShape(RoundedRectangle(cornerRadius: 14))
                    .overlay(RoundedRectangle(cornerRadius: 14)
                        .stroke(MaudeTheme.brass.opacity(0.4), lineWidth: 1))
                    .padding(.top, 4)
                }
                .padding(.horizontal, 26)
            }
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    OnbStepHead(
                        ...
                        lead: String(localized: "A backup is a locked copy kept somewhere else, so a lost or replaced phone doesn't mean losing your history. Only you hold the key — a backup is never readable by Maude, the Foundation, or a cloud operator."),
                        accent: accent, compact: true)
        ...
        Button {
            ...
            HStack(alignment: .top, spacing: 12) {
                OnbIconChip(systemName: icon,
                            color: on ? MaudeTheme.moss : MaudeTheme.ink.opacity(0.10),
                            side: 34, corner: 10)
                    ...
                    HStack(spacing: 7) {
                        ...
                        if let chip {
                            Text(chip.uppercased())
                                .font(.maudeKicker(9))
                                .tracking(0.6)
                                .foregroundStyle(chipAmber ? MaudeTheme.clayText : MaudeTheme.moss)
                                .padding(.horizontal, 6)
                                .padding(.vertical, 2)
                                .background(chipAmber ? MaudeTheme.clay2 : MaudeTheme.moss2)
                                .clipShape(Capsule())
                        }
                    }
                    Text(body)
            ...
            .padding(14)
            .background(on ? MaudeTheme.moss2 : MaudeTheme.paper2)
            .clipShape(RoundedRectangle(cornerRadius: 16))
            .overlay(RoundedRectangle(cornerRadius: 16)
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    OnbStepHead(
                        ...
                        lead: String(localized: "This sets how much detail Maude shows by default — you can change it any time, or go deeper on any screen."),
                        accent: accent, compact: true)
                    ...
                    HStack(alignment: .top, spacing: 9) {
                        Image(systemName: "info.circle")
                            ...
                            .foregroundStyle(MaudeTheme.moss)
                            .padding(.top, 1)
                        Text("Whatever you pick, the deeper layer is always one tap away — Maude never hides your real data.")
                            .font(.lato(12))
                            .lineSpacing(3.5)
                            .foregroundStyle(MaudeTheme.ink2)
                            .fixedSize(horizontal: false, vertical: true)
            ...
            VStack(alignment: .leading, spacing: 0) {
                HStack(alignment: .top, spacing: 12) {
                    Text(level.letter)
                        ...
                        .foregroundStyle(on ? .white : MaudeTheme.ink)
                        .frame(width: 32, height: 32)
                        .background(on ? MaudeTheme.moss : MaudeTheme.ink.opacity(0.08))
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            case "plain":
                HStack(spacing: 8) {
                    ZStack {
                        Circle().fill(MaudeTheme.moss2).frame(width: 24, height: 24)
                        Image(systemName: "checkmark")
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ZStack(alignment: .topLeading) {
                        ...
                        GeometryReader { geo in
                            ...
                            Rectangle()
                                .fill(MaudeTheme.moss.opacity(0.12))
...
// MARK: - Step 9 · How Maude learns you
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    OnbStepHead(
                        ...
                        title: String(localized: "How Maude learns you"),
                        lead: String(localized: "A quick word on what happens next — and why the first couple of weeks look a little quiet."),
                        accent: accent, compact: true)

                    infoCard(icon: "waveform.path.ecg", color: MaudeTheme.accentRecovery,
                             title: String(localized: "It learns your normal first"),
                             body: String(localized: "For about two weeks, Maude mostly watches — building your personal baseline. Early numbers may look bare; that's calibration, not a problem."))
                    infoCard(icon: "bell.badge", color: MaudeTheme.brass,
                    ...
                    infoCard(icon: "sparkles", color: MaudeTheme.moss,
                             title: String(localized: "Ask Maude, on device"),
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        GeometryReader { geo in
                            ZStack(alignment: .leading) {
                                Capsule().fill(MaudeTheme.moss.opacity(0.14))
                                Capsule().fill(MaudeTheme.moss)
                        ...
                        Text("Your first full edition arrives once Maude has enough of your own days to compare against. It only gets sharper from there.")
                            .font(.lato(11.5))
                            .lineSpacing(3.5)
                            .foregroundStyle(MaudeTheme.ink2)
                            .fixedSize(horizontal: false, vertical: true)
