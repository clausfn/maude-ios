    ...
    private var prompt: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 0) {
                ...
                Text("ID")
                    .font(.maudeSerif(22, .bold, relativeTo: .title2))
                ...
                Text("Confirm it's really you.")
                    .font(.maudeSerif(23, .bold, relativeTo: .title2))
                    .kerning(MaudeTheme.Tracking.h1)
                    .foregroundStyle(MaudeTheme.ink)
                    .multilineTextAlignment(.center)
                    .padding(.top, 22)

                Text("To link a national health service, Denmark's MitID confirms your identity. Maude never sees your MitID credentials — the check happens with the official provider, on this device.")
                    .font(.lato(14))
                    .lineSpacing(4)
                ...
                VStack(spacing: 8) {
                    ...
                    checkRow(String(localized: "Maude receives only a yes/no result"))
            ...
            VStack(spacing: 10) {
                ...
                .buttonStyle(.plain)
                Text("You'll return to Maude when you're done.")
                    .font(.lato(11))
                    .foregroundStyle(MaudeTheme.ink3)
            }
            .padding(.horizontal, 26)
