...
public nonisolated struct NudgeEngine: Sendable {
    ...
    private func afibNudge(_ s: ClinicalSignals) -> [EngineNudge] {
        ...
        return [EngineNudge(
            ...
            body: String(localized: "Your device recorded an irregular heart-rhythm signal. Maude does not interpret heart rhythm — please share this recording with \(Specialty.cardiologist.phrase)."),
            priority: 100)]
    }
