...
struct UniversalIsolationTests {
    ...
    @Test func anchorKeysAreNamespaced() throws {
        ...
        let src = try SourceLint.text("Liviqa/Ingestion/UniversalHealthReader.swift")
    ...
    @Test func sourceLintIsolationBothDirections() throws {
        let universalFiles = ["Liviqa/Ingestion/UniversalHealthReader.swift",
                              "Liviqa/Ingestion/UniversalSamples.swift"]
        ...
        for dir in ["Liviqa/Intelligence", "Liviqa/Health"] {
        ...
        for (path, src) in SourceLint.swiftFiles(in: "Liviqa/Ingestion")
...
struct UniversalBrowseTests {
    ...
    // codes decode to HealthKit's own words, never to a Liviqa judgment.
...
struct UniversalBrowserLintTests {
    ...
    @Test func browserCopyContainsNoJudgment() throws {
        let src = try SourceLint.text("Liviqa/Views/DataBrowserView.swift")
