...
struct HealthSummaryDocumentTests {
    ...
    private func fixtureStore() throws -> HealthStore {
        let store = HealthStore(context: ModelContext(try LiviqaStore.makeContainer(inMemory: true)))
    ...
    @Test func summaryReportDelegatesToTheSameDocument() throws {
        ...
        #expect(store.summaryReport().contains("LIVIQA HEALTH SUMMARY"))
    }
    ...
    Exported from Liviqa · your data, shared by you
    """
}
