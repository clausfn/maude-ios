...
struct DonationConsentTests {
    ...
    @Test func controllerInternalIsNotOfferedToCitizens() throws {
        ...
        for file in SourceLint.swiftFiles(in: "Liviqa/Views") {
    ...
    @Test func theDonationUsesTheAppsOwnGrantAndEventTypes() throws {
        let src = try SourceLint.text("Liviqa/Donation/AppState+Donation.swift")
    ...
    @Test func theDonorVersionNamesTheExceptionSpecifically() {
        ...
        #expect(donor.contains("Nothing in Liviqa sends your individual readings anywhere"),
    ...
    @Test func theConsentSurfacesCallTheScopedClaim() throws {
        for path in ["Liviqa/Views/StudyConsentView.swift",
                     "Liviqa/Views/ResearchHubView.swift",
                     "Liviqa/Views/WalletView.swift"] {
        ...
        let privacy = try SourceLint.text("Liviqa/Views/InAppPrivacyView.swift")
