...
//
// Liviqa asks to be believed about what it does and does not do. Six sentences
...
struct ShippedClaimsTests {
    ...
    private let retired: [RetiredClaim] = [
        .init(phrase: "so it opens only for you",
              file: "Liviqa/Views/Onboarding/AppLockSetupView.swift",
              contradictedBy: """
        ...
        .init(phrase: "It cannot be edited, deleted, or backdated",
              file: "Liviqa/Views/Onboarding/OnboardingSteps.swift",
              contradictedBy: """
              ...
              """),
        .init(phrase: "No one, including Liviqa, can alter this record.",
              file: "Liviqa/Views/Onboarding/OnboardingSteps.swift",
        ...
        .init(phrase: "your device answers queries, your data never moves",
              file: "Liviqa/Views/InAppPrivacyView.swift",
              contradictedBy: """
        ...
        .init(phrase: "no recommended hour on this page",
              file: "Liviqa/Views/SleepDetailView.swift",
              contradictedBy: """
    ...
    @Test func onboardingLedgerCopyMatchesTheLedgerScreensOwnGatedRegister() throws {
        let onboarding = try source("Liviqa/Views/Onboarding/OnboardingSteps.swift")
